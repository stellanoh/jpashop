...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Book book = createBook("토지", "박경리", "12345", 10000, 10);
        ...
        assertEquals("주문 가격은 가격 * 수량이다", 10000*count, order.getTotalPrice());
    ...
    public void 상품주문_재고수량초과() throws Exception {
        //given
        Member member = createMember();
        Item book = createBook("토지", "박경리", "12345", 10000, 10);
    ...
    private Member createMember() {
        ...
        member.setName("회원 1");
        member.setAddress(new Address("SEOUL","Gangnam", "16809"));
        em.persist(member);
        return member;
    }
}
